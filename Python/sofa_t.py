...
#lib = dll('E:/Python/pc/test.so')  

#We should give the types for input and return values
#lib.iauPas.argtypes = [c_double, c_double, c_double, c_double]
#lib.iauPas.restype  = c_double
...
#ret_val = lib.iauPas(al, ap, bl, bp)
...
#sf.pymCal2jd(iyear, imon, iday, byref(djm0), ct.byref(djm)) 
...
#delt1 = ps.dtdb(date1, date2, ut, elong, u, v) #OK
print(delt)
line()
...
#d1,d2 = ps.dtf2d(scale,  iy,  im,  id, ihr, imn, sec) #debuging arg 1
line()
...
print(ut11,ut12)
#ut11, ut12= ps.taiut1(tai1, tai2, dta)
#print(ut11,ut12)
line()
...
print(days)
#days = ps.tf2d(s, ihour, imin, sec)  #debuging using c_wchar than c_char 

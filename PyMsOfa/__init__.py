...
Thematic sub-modules remain importable if you prefer them::
    ...
    from PyMsOfa import PyMsOfa_time   as t     # alias without the `_n` suffix
...
--------------------
This file is hand-written and is NOT regenerated by ``_make_package.py``.
When bumping the version, change BOTH ``__version__`` below and ``version``
in ``pyproject.toml``.
"""
...
from . import PyMsOfa_basic_n               # noqa: F401
from . import PyMsOfa_time_n                # noqa: F401
from . import PyMsOfa_earth_attitude_n      # noqa: F401
from . import PyMsOfa_astrometry_n          # noqa: F401
...
# --- `_n`-less aliases (PyMsOfa.PyMsOfa_time, ...) -------------------------
...
__all__ = _build_all() + [
    ...
    "PyMsOfa_basic_n",
    "PyMsOfa_time_n",
    "PyMsOfa_earth_attitude_n",
    "PyMsOfa_astrometry_n",
    "PyMsOfa_basic",
    "PyMsOfa_time",
